...
function DeleteReferenceRemarkDialog({ remark, dialog, setDialog }: Props) {
  ...
  return (
    <Dialog open={dialog === 'DeleteReferenceRemarkDialog'}
    >
...
export default DeleteReferenceRemarkDialog

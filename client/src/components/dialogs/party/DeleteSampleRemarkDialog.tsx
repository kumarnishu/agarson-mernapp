...
function DeleteSampleRemarkDialog({ remark, dialog, setDialog }: Props) {
  const { setAlert } = useContext(AlertContext)
  const { mutate, isLoading, isSuccess, error, isError } = useMutation
    <AxiosResponse<any>, BackendError, string>
    (new PartyPageService().DeleteSampleRemark, {
      onSuccess: () => {
  ...
  return (
    <Dialog open={dialog === "DeleteSampleRemarkDialog"}
    >
...
export default DeleteSampleRemarkDialog

...
import { DeleteChecklistRemark, GetChecklistRemarkHistory, NewChecklistRemark, UpdateChecklistRemark } from "../controllers/checklist-remark";
const router = express.Router()

router.route("/checklist/remarks/:id").get(isAuthenticatedUser, GetChecklistRemarkHistory)
router.route("checklist/remarks/:id").post(isAuthenticatedUser, NewChecklistRemark)

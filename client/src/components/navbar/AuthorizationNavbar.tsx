      ...
      <Paper sx={{ bgcolor: 'grey', width: '100vw' }}>
        ...
        >
          ...
          <Stack
            ...
            gap={2}
          >
            <Link title="Double-click to access the main dashboard, or single-click to return." to={"/Authorization"} onDoubleClick={() => navigate("/")}  replace={true} style={{ textDecoration: 'none' }}>

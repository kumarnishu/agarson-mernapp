      ...
      <Paper sx={{ bgcolor: 'grey', width: '100vw' }}>
        ...
        >
          ...
          <Stack
            ...
            gap={2}
          >
            <Link to={"/Authorization"} title="Double-click to access the main dashboard, or single-click to return." onDoubleClick={() => navigate("/")} replace={true} style={{ textDecoration: 'none' }}>

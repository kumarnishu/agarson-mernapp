...
function CreateOrEditAgeingRemarkForm({ party, remark, setDialog }: {
    party: string,
    remark?: GetAgeingRemarkDto, setDialog: React.Dispatch<React.SetStateAction<string | undefined>>
}) {
    ...
    const { mutate, isLoading, isSuccess } = useMutation
        ...
        (new SalesService().CreateOrEditAgeingRemark, {

            onSuccess: () => {
                queryClient.refetchQueries('remarks')
                queryClient.refetchQueries('ageing')
...
export default CreateOrEditAgeingRemarkForm

...
import { AddMaintenanceItemRemark, CreateMaintenance, CreateMaintenanceCategory, CreateMaintenanceFromExcel, DeleteMaintenance,  DownloadExcelTemplateForMaintenance, GetAllMaintenance, GetAllMaintenanceCategory, GetAllMaintenanceReport, ToogleMaintenanceCategory, ToogleMaintenanceItem, UpdateMaintenance, UpdateMaintenanceCategory, ViewMaintenanceItemRemarkHistory } from "../controllers/maintenance.controller";
...
router.route("/maintenances/:id").put(isAuthenticatedUser, upload.single("none"), UpdateMaintenance).delete(isAuthenticatedUser, DeleteMaintenance)
router.route("/maintenances/item/toogle/:id").patch(isAuthenticatedUser, ToogleMaintenanceItem)
router.route("/maintenances/item/remarks/:id").get(isAuthenticatedUser, ViewMaintenanceItemRemarkHistory).post(isAuthenticatedUser,AddMaintenanceItemRemark)

...
import { SpareDye, ISpareDye } from '../models/spare-dye';
import { ShoeWeight, IShoeWeight } from '../models/shoe-weight';
...
// DTOs
import {
  CreateOrEditArticleDto,
  GetArticleDto,
  GetDyeDto,
  GetDyeDtoFromExcel,
  GetShoeWeightDiffReportDto,
  GetCategoryWiseProductionReportDto,
  CreateOrEditProductionDto,
  GetProductionDto,
  GetDyeLocationDto,
  CreateOrEditDyeLocationDto,
  GetDyeStatusReportDto,
  CreateOrEditDyeDTo,
  ...
  IRowData,
  GetShoeWeightDto,
  CreateOrEditShoeWeightDto,
  GetSoleThicknessDto,
  CreateOrEditSoleThicknessDto,
  GetSpareDyeDto,
  CreateOrEditSpareDyeDto,
} from '../dtos';
